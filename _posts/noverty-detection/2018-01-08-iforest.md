...
> -  when **<span style='color:red'>$s \rightarrow 0.5$</span>** $\quad E(h(x))$ **<span style='color:red'>$\rightarrow c(n)$</span>**
> -  when **<span style='color:green'>$s \rightarrow 1,$</span>** $\quad E(h(x))$ **<span style='color:green'>$\rightarrow 0$</span>**
> -  when **<span style='color:blue'>$s \rightarrow 0,$</span>** $\quad E(h(x))$ **<span style='color:blue'>$\rightarrow n-1$</span>**
