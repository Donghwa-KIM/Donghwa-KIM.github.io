...
- 반면에, gradients-based guided Backpropagation은 특정 class(확률이 가장 높은)에 대해서 **$1)$ gradients(w.r.t last conv)가 0보다 크며 $2)$ relu outputs이 양수인 부분인 gradients**만 feature map에 곱하는 방식(weighted-average)
...
- **<span style='color:blue'>Guided Backpropagatio-based</span>**:
$1)$ gradients(w.r.t last conv)가 0보다 크며 $2)$ relu outputs이 양수인 부분인 gradients를 계산하는 방식
- {'```Relu```': '```GuidedRelu```'}: ```Relu```의 그래디언트 계산방식을 ```GuidedRelu```로 변환
...
<p align="center"><img width="600" height="auto" src="https://i.imgur.com/acp1Ftc.png"></p>
...
<p align="center"><img width="300" height="auto" src="https://i.imgur.com/fBb4WSe.png"></p>
...
<p align="center"><img width="300" height="auto" src="https://i.imgur.com/2JahwqV.png"></p>
...
<p align="center"><img width="300" height="auto" src="https://i.imgur.com/nLPV9cv.png"></p>
---
...
<p align="center"><img width="600" height="auto" src="https://i.imgur.com/griaQS7.png"></p>
...
<p align="center"><img width="600" height="auto" src="https://i.imgur.com/AVc59bl.png"></p>
